...
Note that in the fine tuning / training phase, privacy depends on the region specific cloud storage data centers you can direct the Hugging Face / PyTorch platform to use. European cloud storage does privacy better than the United States because of the EU rules they operate under. But Africa is a future too:
